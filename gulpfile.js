...
gulp.task('publish', function() {
    return gulp.src(['./public/**/*']).pipe(gulp.dest('../sites/landingzero'));
});
...
gulp.task('css', function () {
    return sass([config.sassPath + '/style.scss',config.sassPath + '/landing.scss'], {
        style: 'compressed',
        loadPath: [
            config.sassPath,
            config.bowerDir + '/Han',
            config.bowerDir + '/bootstrap-sass/assets/stylesheets',
            config.bowerDir + '/Ionicons/scss'
        ]
    })
